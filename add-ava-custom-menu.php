...
add_action( 'ava-fields/init', function () {
	...
	$params = array(
		...
		'container' => array(
			'type'     => 'custom',
			'id'       => 'avaf_custom_menu',
			'title'    => __( 'Custom Menu title', '' ),
			'subtitle' => __( 'Custom Menu subtitle', '' ),
		),

		'menu' => array(
			'parent' => '', // options, theme, plugins, users, dashboard, posts, media
			'menu_title' => __('AVA Custom Menu', '{domain}'),
			'menu_slug'  => 'avaf_custom_menu',
		),
