...
add_action( 'ava-fields/init', function () {
	...
	$params = array(
		...
		'container' => array(
			'type'     => 'custom',
			'id'       => 'avaf_plugins_options',
			'title'    => __( 'AVA Plugins title', '' ),
			'subtitle' => __( 'AVA Plugins subtitle', '' ),
		),

		'menu' => array(
			'parent'     => 'plugins', // options, theme, plugins, users, dashboard, posts, media
			'menu_title' => __('AVA Plugins', '{domain}'),
			'menu_slug'  => 'avaf_plugins_options',
		),
		...
		'options' => array(
			'option_name' => 'avaf_plugins_options'
		),
