...
add_action( 'ava-fields/init', function () {
	...
	$params = array(
		...
		'container' => array(
			'type'     => 'custom',
			'id'       => 'avaf_users_options',
			'title'    => __( 'AVA Users title', '' ),
			'subtitle' => __( 'AVA Users subtitle', '' ),
		),

		'menu' => array(
			'parent'     => 'users', // options, theme, plugins, users, dashboard, posts, media
			'menu_title' => __('AVA Users', '{domain}'),
			'menu_slug'  => 'avaf_users_options',
		),
		...
		'options' => array(
			'option_name' => 'avaf_users_options'
		),
